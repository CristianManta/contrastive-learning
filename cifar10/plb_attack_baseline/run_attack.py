...
parser = argparse.ArgumentParser('Attack an example CIFAR-10 baseline model with the ProxLogBarrier attack.'
...
groups0.add_argument('--model-path', type=str,
                     default='/home/math/dragos.manta/contrastive/ContrastiveTeamO/cifar10/runs_baseline/best.pth.tar',
                     metavar='DIR', help='Directory where baseline model is saved')
