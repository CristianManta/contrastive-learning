...
groups0.add_argument('--model-path', type=str,default='/home/math/dragos.manta/contrastive/ContrastiveTeamO/cifar10/runs/encoder_best.pth.tar',
        metavar='DIR', help='Directory where model is saved')
groups0.add_argument('--clf-path', type=str,default='/home/math/dragos.manta/contrastive/ContrastiveTeamO/cifar10/runs/classifier_best.pth.tar',
        metavar='DIR', help='Directory where model is saved')
