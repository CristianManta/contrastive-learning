...
class SmallNet(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.m = nn.Sequential(
            Conv(1, 32, kernel_size=(3, 3), padding=0, stride=1, bn=False),
            nn.ReLU(),
            Conv(32, 32, kernel_size=(3, 3), padding=0, stride=1, bn=False),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),
            Conv(32, 64, kernel_size=(3, 3), padding=0, stride=1, bn=False),
            nn.ReLU(),
            Conv(64, 64, kernel_size=(3, 3), padding=0, stride=1, bn=False),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),
            View(64 * 4 * 4),
